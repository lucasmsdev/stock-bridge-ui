...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-background font-body">
      ...
      {/* Features - Bento Grid */}
      <section id="funcoes" className="py-20 bg-gradient-to-b from-background to-muted/30 scroll-mt-16">
      ...
      {/* FAQ Section */}
      <section id="faq" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-background to-muted/30">
