...
export default function MagaluCallback() {
  ...
  useEffect(() => {
    const processCallback = async () => {
      ...
      if (error) {
        console.error('Magalu authorization error:', error);
        toast({
          title: "Erro na autorização",
          description: "Não foi possível conectar com o Magalu. Tente novamente.",
          variant: "destructive",
        });
      ...
      try {
        ...
        const { data, error: functionError } = await supabase.functions.invoke('magalu-auth', {
          body: {
            code,
            redirect_uri: `${window.location.origin}/callback/magalu`
          }
        });
        ...
        toast({
          ...
          description: "Magalu conectado ao seu UniStock.",
        });
